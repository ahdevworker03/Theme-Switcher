...
function Ac(e, n, t, r, l, o, u, i, s) {
  ((Ct = !1), (Rr = null), Uc.apply($c, arguments));
}
...
function pt(e, n) {
  e.blockedOn === n &&
    ...
    ao ||
      ((ao = !0),
      ve.unstable_scheduleCallback(ve.unstable_NormalPriority, tf)));
}
function jt(e) {
  function n(l) {
    return pt(l, e);
...
function bo(e, n, t, r) {
  if (Ir) {
    ...
    else if ((Yu(e, r), n & 4 && -1 < ef.indexOf(e))) {
      for (; l !== null; ) {
        var o = Jt(l);
        if (
          (o !== null && zs(o),
...
function rd(e, n, t) {
  ...
  if (Ca(e)) _a(n, l);
    ...
    ((t = la(e, n, l, r)),
      t !== null && ((l = oe()), Oe(t, e, r, l), xa(t, n, r)));
  }
}
function Ca(e) {
  var n = e.alternate;
...
function Ti(e, n, t, r, l) {
  ...
  if ((Gn(n, l), n.stateNode === null))
    (Pr(e, n), Pa(n, t, r), _o(n, t, r, l), (r = !0));
  else if (e === null) {
    var u = n.stateNode,
      i = n.memoizedProps;
    u.props = i;
...
function Ua(e) {
  ...
  (n !== null && ((e.alternate = null), Ua(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[je], delete n[Vt], delete n[go], delete n[Zf], delete n[Jf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function de(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Ku(t), n === 1))
      (e.tag === 0 ? qf(Ui.bind(null, e)) : qs(Ui.bind(null, e)),
        Xf(function () {
          !(R & 6) && hn();
        }),
        (t = null));
...
function Cn(e, n) {
  ...
  if ((t !== -1 && ((e.timeoutHandle = -1), Yf(t)), Q !== null))
...
Ga = function (e, n, t) {
  if (e !== null)
    if (e.memoizedProps !== n.pendingProps || ce.current) ae = !0;
      ...
      if (!(e.lanes & t) && !(n.flags & 128)) return ((ae = !1), cd(e, n, t));
      ae = !!(e.flags & 131072);
    }
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Jo(n, t | 1), de(n, W()), !(R & 6) && ((rt = W() + 500), hn()));
      }
      break;
    case 13:
      (Tn(function () {
...
ys = xu;
gs = Tn;
var Ld = { usingClientEntryPoint: !1, Events: [Jt, Un, ol, hs, vs, xu] },
  yt = {
...
const nc = ot.createContext(),
  tc = () => {
    const e = ot.useContext(nc);
    if (!e) throw new Error("useTheme must be used within a ThemeProvider");
    return e;
  },
  Md = ({ children: e }) => {
    const [n, t] = ot.useState("light"),
      r = () => {
        t((l) => (l === "light" ? "dark" : "light"));
      };
    return ke.jsx(nc.Provider, {
      value: { theme: n, toggleTheme: r },
      children: e,
    });
  },
  Dd = () => {
    const { theme: e, toggleTheme: n } = tc();
    return ke.jsxs("div", {
      className: `theme-switcher ${e}`,
      children: [
        ke.jsx("h1", { children: "Theme Switcher" }),
        ke.jsxs("p", {
          children: [
            "Current Theme:",
            " ",
        ...
        ke.jsx("button", {
          ...
          children: e === "light" ? "🌙 Switch to Dark" : "☀️ Switch to Light",
        }),
      ],
    });
  };
function Id() {
  const { theme: e } = tc();
  return ke.jsx("div", { className: `app ${e}`, children: ke.jsx(Dd, {}) });
}
function jd() {
  return ke.jsx(Md, { children: ke.jsx(Id, {}) });
}
Ql.createRoot(document.getElementById("root")).render(
  ke.jsx(Sc.StrictMode, { children: ke.jsx(jd, {}) }),
);
